...
<p align="left">
  <a href="https://www.linkedin.com/in/artur-galdino-342445365/" target="_blank">
    <img src="https://img.shields.io/badge/-LinkedIn-%230077B5?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn" />
  </a>
  <a href="mailto:fernandesartur4@gmail.com">
...
Throughout my academic and professional journey, I have combined core software engineering principles with practical execution across full-stack applications, system architecture, and client-facing roles:

* **Junior Enterprise Leadership:** Serving as a **Project Advisor** at **Orc'estra (Software Engineering Junior Enterprise)**, applying agile methodologies, clean architecture, and user engagement strategies to deliver robust web platforms. Previously acted as a **Business Advisor**, gaining hands-on experience in sales, process mapping, and client relations.
* **Technical Initiatives & Projects:** Experienced in engineering end-to-end applications—ranging from CI/CD-driven platforms, healthcare transparency data engines, and AST interpreters in C to cloud-synced autonomous robotics and machine learning models (AWS DeepRacer).

I have built a solid foundation in **OOP**, **Clean Code**, **Data Structures**, **Automated Testing & QA**, **Layered Architecture**, **CI/CD**, and **Full-Stack Web Development**.

Additionally, I hold **English proficiency**, reinforced by a 1-year academic immersion in **Orlando, Florida (USA)**, along with **basic French**, enabling seamless communication in global and technical environments.
...
- **Repos:** 2 {Contributed: 2} | **Stars:** 2 | **Followers:** 6
- **Commits:** 377 | **Merged PRs:** 26 | **Code Reviews:** 0
- **Issues:** 3 Open | 28 Closed
- **Top Languages:** Java 98.0% | Python 2.0%
- **Lines of Code on GitHub:** 191,351 (241,829++, 50,478--)
